...
namespace SusFoodBank.Pages.Appointment.Staff
{
    ...
    public class BookingInfoModel : PageModel
    {
        ...
        public BookingInfoModel(UserManager<ApplicationUser> userManager, BookingService bookingService, SlotService slotService, SlotSessionService slotSessionService)
        {
        ...
        public async Task<IActionResult> OnPostAsync(int id)
        {
            ...
            _bookingService.UpdateBooking(MyBooking);
