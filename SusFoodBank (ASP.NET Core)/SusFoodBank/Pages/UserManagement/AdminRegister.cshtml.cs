...
namespace SusFoodBank.Pages.UserManagement
{
	public class AdminRegisterModel : PageModel
	{
		...
		public AdminRegisterModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IWebHostEnvironment environment, RoleManager<IdentityRole> roleManager, MyDbContext myDbContext)
		{
