...
let sendEmail = (ticketSubject, username, ticketCategory, ticketMessage) => {
	let params = {
		...
		Message: {
			Body: {
				Html: {
					...
					<div style="text-align: center;">
						...
						<p>Please be informed of a newly opened support ticket that requires your attention.</p>
						<p style="font-weight: bold;">Below are the details of the support ticket:</p>
						<p>
						...
						<p>
							<span style="font-weight: bold;">Message: </span>${ticketMessage}
						</p>
						<hr>
			...
			Subject: {
				Charset: 'UTF-8',
				Data: `NEW TICKET CREATED: ${ticketSubject}`
			}
		},
	};
